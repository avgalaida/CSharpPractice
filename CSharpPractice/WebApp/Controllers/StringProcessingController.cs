...
namespace WebApp.Controllers
{
    ...
    public class StringProcessingController : ControllerBase
    {
        ...
        {
            if (!_stringProcessor.CanProcessRequest())
            {
            ...
            try
            {
                ...
                SortAlgorithmNames sortAlgorithm = algorithm == 2 ? SortAlgorithmNames.TreeSort : SortAlgorithmNames.QuickSort;
            ...
            {
                _stringProcessor.ReleaseProcessing();
            }
        }
    }
}